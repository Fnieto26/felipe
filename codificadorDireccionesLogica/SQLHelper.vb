...
#Region "private utility methods & constructors"
        ...
        If (Not commandParameters Is Nothing) Then
            ...
            For Each p In commandParameters
                If (Not p Is Nothing) Then
                    ...
                    If (p.Direction = Data.ParameterDirection.InputOutput OrElse p.Direction = Data.ParameterDirection.Input) AndAlso p.Value Is Nothing Then
    ...
    Private Overloads Shared Sub AssignParameterValues(ByVal commandParameters() As SqlParameter, ByVal dataRow As Data.DataRow)
    ...
    Private Overloads Shared Sub AssignParameterValues(ByVal commandParameters() As SqlParameter, ByVal parameterValues() As Object)
        ...
        For i = 0 To j
            ...
            If TypeOf parameterValues(i) Is Data.IDbDataParameter Then
                Dim paramInstance As Data.IDbDataParameter = CType(parameterValues(i), Data.IDbDataParameter)
...
#Region "ExecuteNonQuery"
    ...
    Public Overloads Shared Function ExecuteNonQuery(ByVal connectionString As String, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            Return ExecuteNonQuery(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
            ' Otherwise we can just call the SP without params
        Else
            Return ExecuteNonQuery(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteNonQuery
    ...
    Public Overloads Shared Function ExecuteNonQuery(ByVal connection As SqlConnection, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteNonQuery(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteNonQuery(connection, Data.CommandType.StoredProcedure, spName)
        End If
    ...
    Public Overloads Shared Function ExecuteNonQuery(ByVal transaction As SqlTransaction, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteNonQuery(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteNonQuery(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteNonQuery
...
#Region "ExecuteDataset"
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal connectionString As String, _
                                                    ByVal commandType As Data.CommandType, _
                                                    ByVal commandText As String) As Data.DataSet
        ' Pass through the call providing null for the set of SqlParameters
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal connectionString As String, _
                                                    ByVal commandType As Data.CommandType, _
                                                    ByVal commandText As String, _
                                                    ByVal ParamArray commandParameters() As SqlParameter) As Data.DataSet
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal connectionString As String, _
                                                    ByVal spName As String, _
                                                    ByVal ParamArray parameterValues() As Object) As Data.DataSet
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteDataset(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteDataset(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteDataset
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal connection As SqlConnection, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteDataset(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteDataset(connection, Data.CommandType.StoredProcedure, spName)
        End If
    ...
    Public Overloads Shared Function ExecuteDataset(ByVal transaction As SqlTransaction, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteDataset(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteDataset(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteDataset
...
#Region "ExecuteReader"
    ...
    Private Overloads Shared Function ExecuteReader(ByVal connection As SqlConnection, _
        ...
        Try
            ...
            For Each commandParameter In cmd.Parameters
                If commandParameter.Direction <> Data.ParameterDirection.Input Then
                    canClear = False
                End If
            Next
    ...
    Public Overloads Shared Function ExecuteReader(ByVal connectionString As String, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteReader(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
            ' Otherwise we can just call the SP without params
        Else
            Return ExecuteReader(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteReader
    ...
    Public Overloads Shared Function ExecuteReader(ByVal connection As SqlConnection, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            Return ExecuteReader(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteReader(connection, Data.CommandType.StoredProcedure, spName)
        End If
    ...
    Public Overloads Shared Function ExecuteReader(ByVal transaction As SqlTransaction, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            Return ExecuteReader(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteReader(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteReader
...
#Region "ExecuteScalar"
    ...
    Public Overloads Shared Function ExecuteScalar(ByVal connectionString As String, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteScalar(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
            ' Otherwise we can just call the SP without params
        Else
            Return ExecuteScalar(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteScalar
    ...
    Public Overloads Shared Function ExecuteScalar(ByVal connection As SqlConnection, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteScalar(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteScalar(connection, Data.CommandType.StoredProcedure, spName)
        End If
    ...
    Public Overloads Shared Function ExecuteScalar(ByVal transaction As SqlTransaction, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteScalar(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else ' Otherwise we can just call the SP without params
            Return ExecuteScalar(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteScalar
...
#Region "ExecuteXmlReader"
    ...
    Public Overloads Shared Function ExecuteXmlReader(ByVal connection As SqlConnection, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteXmlReader(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
            ' Otherwise we can just call the SP without params
        Else
            Return ExecuteXmlReader(connection, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteXmlReader
    ...
    Public Overloads Shared Function ExecuteXmlReader(ByVal transaction As SqlTransaction, _
        ...
        If Not (parameterValues Is Nothing) AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            Return ExecuteXmlReader(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
            ' Otherwise we can just call the SP without params
        Else
            Return ExecuteXmlReader(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function ' ExecuteXmlReader
...
#Region "FillDataset"
    ...
    Public Overloads Shared Sub FillDataset(ByVal connectionString As String, ByVal commandType As Data.CommandType, ByVal commandText As String, ByVal dataSet As Data.DataSet, ByVal tableNames() As String)
    ...
    '               by a user defined name (probably the actual table name)
    ' -commandParameters: An array of SqlParamters used to execute the command
    Public Overloads Shared Sub FillDataset(ByVal connectionString As String, ByVal commandType As Data.CommandType, ByVal commandText As String, ByVal dataSet As Data.DataSet, _
    ...
    Public Overloads Shared Sub FillDataset(ByVal connectionString As String, ByVal spName As String, _
        ByVal dataSet As Data.DataSet, ByVal tableNames As String(), ByVal ParamArray parameterValues() As Object)
    ...
    ' -tableNames: this array will be used to create table mappings allowing the DataTables to be referenced
    ' by a user defined name (probably the actual table name)
    Public Overloads Shared Sub FillDataset(ByVal connection As SqlConnection, ByVal commandType As Data.CommandType, _
        ByVal commandText As String, ByVal dataSet As Data.DataSet, ByVal tableNames As String())
    ...
    ' -commandParameters: An array of SqlParamters used to execute the command
    Public Overloads Shared Sub FillDataset(ByVal connection As SqlConnection, ByVal commandType As Data.CommandType, _
    ByVal commandText As String, ByVal dataSet As Data.DataSet, ByVal tableNames As String(), _
    ...
    '             by a user defined name (probably the actual table name)
    ' -parameterValues: An array of objects to be assigned as the input values of the stored procedure
    Public Overloads Shared Sub FillDataset(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataSet As Data.DataSet, _
        ...
        If Not parameterValues Is Nothing AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            FillDataset(connection, Data.CommandType.StoredProcedure, spName, dataSet, tableNames, commandParameters)
        Else ' Otherwise we can just call the SP without params
            FillDataset(connection, Data.CommandType.StoredProcedure, spName, dataSet, tableNames)
        End If
    ...
    ' -tableNames: this array will be used to create table mappings allowing the DataTables to be referenced
    '             by a user defined name (probably the actual table name)
    Public Overloads Shared Sub FillDataset(ByVal transaction As SqlTransaction, ByVal commandType As Data.CommandType, _
        ByVal commandText As String, ByVal dataSet As Data.DataSet, ByVal tableNames() As String)
    ...
    Public Overloads Shared Sub FillDataset(ByVal transaction As SqlTransaction, ByVal spName As String, _
        ...
        If Not parameterValues Is Nothing AndAlso parameterValues.Length > 0 Then
            ...
            ' Call the overload that takes an array of SqlParameters
            FillDataset(transaction, Data.CommandType.StoredProcedure, spName, dataSet, tableNames, commandParameters)
        Else ' Otherwise we can just call the SP without params
            FillDataset(transaction, Data.CommandType.StoredProcedure, spName, dataSet, tableNames)
        End If
    End Sub
    ...
    '             by a user defined name (probably the actual table name)
    ' -commandParameters: An array of SqlParamters used to execute the command
    Private Overloads Shared Sub FillDataset(ByVal connection As SqlConnection, ByVal transaction As SqlTransaction, ByVal commandType As Data.CommandType, _
        ByVal commandText As String, ByVal dataSet As Data.DataSet, ByVal tableNames() As String, _
        ByVal ParamArray commandParameters() As SqlParameter)
...
#Region "UpdateDataset"
    ...
    Public Overloads Shared Sub UpdateDataset(ByVal insertCommand As SqlCommand, ByVal deleteCommand As SqlCommand, ByVal updateCommand As SqlCommand, ByVal dataSet As Data.DataSet, ByVal tableName As String)
...
#Region "ExecuteNonQueryTypedParams"
    ...
    Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As Data.DataRow) As Integer
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns:
    ' an int representing the number of rows affected by the command
    Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As Data.DataRow) As Integer
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(connection, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns:
    ' an int representing the number of rows affected by the command
    Public Overloads Shared Function ExecuteNonQueryTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As Data.DataRow) As Integer
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteNonQueryTypedParams = SqlHelper.ExecuteNonQuery(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteDatasetTypedParams"
    ...
    Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As Data.DataRow) As Data.DataSet
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns:
    ' a dataset containing the resultset generated by the command
    Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As Data.DataRow) As Data.DataSet
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(connection, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns:
    ' a dataset containing the resultset generated by the command
    Public Overloads Shared Function ExecuteDatasetTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As Data.DataRow) As Data.DataSet
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then Throw New ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else

            ExecuteDatasetTypedParams = SqlHelper.ExecuteDataset(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteReaderTypedParams"
    ...
    Public Overloads Shared Function ExecuteReaderTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As Data.DataRow) As SqlDataReader
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteReaderTypedParams = SqlHelper.ExecuteReader(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteReaderTypedParams = SqlHelper.ExecuteReader(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns:
    ' a SqlDataReader containing the resultset generated by the command
    Public Overloads Shared Function ExecuteReaderTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As Data.DataRow) As SqlDataReader
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteReaderTypedParams = SqlHelper.ExecuteReader(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteReaderTypedParams = SqlHelper.ExecuteReader(connection, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns:
    ' a SqlDataReader containing the resultset generated by the command
    Public Overloads Shared Function ExecuteReaderTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As Data.DataRow) As SqlDataReader
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then Throw New ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteReaderTypedParams = SqlHelper.ExecuteReader(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteReaderTypedParams = SqlHelper.ExecuteReader(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteScalarTypedParams"
    ...
    Public Overloads Shared Function ExecuteScalarTypedParams(ByVal connectionString As String, ByVal spName As String, ByVal dataRow As Data.DataRow) As Object
        If (connectionString Is Nothing OrElse connectionString.Length = 0) Then Throw New ArgumentNullException("connectionString")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ' If the row has values, the store procedure parameters must be initialized
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(connectionString, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(connectionString, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns: 
    ' an object containing the value in the 1x1 resultset generated by the command</returns>
    Public Overloads Shared Function ExecuteScalarTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As Data.DataRow) As Object
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(connection, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns: 
    ' an object containing the value in the 1x1 resultset generated by the command</returns>
    Public Overloads Shared Function ExecuteScalarTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As Data.DataRow) As Object
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then Throw New ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ...
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteScalarTypedParams = SqlHelper.ExecuteScalar(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
...
#Region "ExecuteXmlReaderTypedParams"
    ...
    Public Overloads Shared Function ExecuteXmlReaderTypedParams(ByVal connection As SqlConnection, ByVal spName As String, ByVal dataRow As Data.DataRow) As XmlReader
        If (connection Is Nothing) Then Throw New ArgumentNullException("connection")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ' If the row has values, the store procedure parameters must be initialized
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteXmlReaderTypedParams = SqlHelper.ExecuteXmlReader(connection, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteXmlReaderTypedParams = SqlHelper.ExecuteXmlReader(connection, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
    ...
    ' Returns: 
    ' an XmlReader containing the resultset generated by the command
    Public Overloads Shared Function ExecuteXmlReaderTypedParams(ByVal transaction As SqlTransaction, ByVal spName As String, ByVal dataRow As Data.DataRow) As XmlReader
        If (transaction Is Nothing) Then Throw New ArgumentNullException("transaction")
        If Not (transaction Is Nothing) AndAlso (transaction.Connection Is Nothing) Then Throw New ArgumentException("The transaction was rollbacked or commited, please provide an open transaction.", "transaction")
        If (spName Is Nothing OrElse spName.Length = 0) Then Throw New ArgumentNullException("spName")
        ' if the row has values, the store procedure parameters must be initialized
        If (Not dataRow Is Nothing AndAlso dataRow.ItemArray.Length > 0) Then
            ...
            ExecuteXmlReaderTypedParams = SqlHelper.ExecuteXmlReader(transaction, Data.CommandType.StoredProcedure, spName, commandParameters)
        Else
            ExecuteXmlReaderTypedParams = SqlHelper.ExecuteXmlReader(transaction, Data.CommandType.StoredProcedure, spName)
        End If
    End Function
#End Region
End Class ' SqlHelper
